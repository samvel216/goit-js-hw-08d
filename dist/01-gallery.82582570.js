...
var showGallery = _galleryItems.galleryItems.map(function (element) {
  return "<a class=\"gallery__item\" href=\"".concat(element.original, "\">\n  <img class=\"gallery__image\" src=\"").concat(element.preview, "\" alt=\"").concat(element.description, "\" title=\"").concat(element.description, "\"/>\n</a>");
}).join("");
